                ...
                >
                  <div className="flex flex-col lg:flex-row grow">
                    ...
                    <div className="px-6 sm:px-8 md:px-10 py-10 grow">
                      <h3 className="text-gray-700 text-xl lg:text-2xl font-semibold title-font mb-5 transition-all duration-150 ease-out group-hover:text-yellow-500">
                        {post.data.title}
                      </h3>
                      {post.data.excerpt && (
                  ...
                  <div className="flex items-center flex-wrap gap-2">
                    <EventDates
                      ...
                      endDate={new Date(post.data.endDate)}
                    />
                  </div>
                </a>
              );
