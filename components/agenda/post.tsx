...
import { PostType } from "../../pages/agenda/[filename]";
  ...
  return (
    <Section className="flex-1">
      <Container width="small" className={`flex-1 pb-2`} size="large">
        ...
        <div
          data-tina-field={tinaField(props, "organizer")}
          ...
          {props.organizer && (
            <>
              <div className="flex-shrink-0 mr-4">
                <img
                  data-tina-field={tinaField(props.organizer, "avatar")}
                  className="h-14 w-14 object-cover rounded-full shadow-sm"
                  src={props.organizer.avatar}
                  alt={props.organizer.name}
                />
              </div>
              <p
                data-tina-field={tinaField(props.organizer, "name")}
